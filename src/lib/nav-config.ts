import {
  ...
  Building2, ShoppingBag, ClipboardList, Wrench, Wallet, CalendarCheck, CalendarDays, Banknote, ListTodo, Target, MessageSquare, CalendarRange,
} from 'lucide-react'
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Finance',          href: '/finance',    icon: Wallet,          roles: ['founder', 'finance'] },
  ...
  { label: 'Goals',            href: '/goals',      icon: Target,          roles: ALL_ROLES },
  { label: 'Chat',             href: '/chat',       icon: MessageSquare,   roles: ALL_ROLES },
  { label: 'Calendar',         href: '/calendar',   icon: CalendarRange,   roles: ALL_ROLES },
